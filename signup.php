...
<div class="login-page">
    <div class="form">
        ...
        <form method="post" action="./controllers/Users.php" class="login-form">
            ...
            <input type="text" name="usersName" placeholder="Tên người dùng">
            <input type="textd" name="usersEmail" placeholder="Email người dùng">
            <input type="password" name="usersPwd" placeholder="Mật khẩu">
            <input type="password" name="pwdRepeat" placeholder="Nhập lại mật khẩu">
            <?php
        ...
        ?>
            ...
            <p class="message">Đã có tài khoản? <a href="./login.php" style="top: 14px;left: 30px;">Đăng nhập</a></p> 
        </form>
