...
<!-- SLIDE SHOW -->
    <div class="slider" style=" max-width: 639px; top: 205px;">
                <div class="list">
                    <div class="item">
    ...
    <!-- search -->
    <div class="search-with" style=" top: 135px;">
        <div class="dropdown">
    ...
    <div class="container">
        <div class="wrap-bread-crumb">
            <div class="bread-crumb">
                <a href="PetShopBoom.php" class="">Trang chủ</a>
            ...
            <div class="item-product item-product-grid">
                <div class="product-thumb">
                    ...
                    <div class="product-extra-link text-center product" style="z-index: 1;">
                        ...
                        <a href="login.php" rel="noffolw" data-product-id="86466" data-product-sku="SP00596" data-quantity="1" class="button addcart-link shop-button bg-color product_type_simple add_to_cart_button s7upf_ajax_add_to_cart product_type_simple" data-title="GOLDEN CÁI">
                            <span>Mua Hàng</span>
                        </a>
                    </div>
                </div>    
...
<div class="list-col-item list-4-item">
    <div class="item-product item-product-grid">
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index: 1;">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal2')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
        ...
        <div class="product-info">
            ...
            <h3 class="title18 text-upprcase product-title dosis-font font-bold">
                <a href="#" class="black" title="PHỐC SỐC TRẮNG">PHỐC SỐC TRẮNG</a>
            </h3>
            <div class="product-price simple">
        ...
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal3')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
        ...
        <div class="modal" id="productModal3"> 
            ...
            <span class="close" onclick="closeModal('productModal3')">&times;</span>        
                    ...
                    <div class="produt-details">
                        <p><strong>Tên sản phẩm:</trong> </p>
                        <p><strong>Giá:</trong> <p>
                        <p><strong>Mô tả:</trong> <p>
                    </div>
        </div>
    </div>
        <div class="product-info">
            ...
            <h3 class="title18 text-upprcase product-title dosis-font font-bold">
                <a href="#" class="black" title="POODLE NÂU XINH">POODLE NÂU XINH</a>
            </h3>
            <div class="product-price simple">
...
<div class="list-col-item list-4-item">
    <div class="item-product item-product-grid">
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal4')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i> 
                            <span>Xem nhanh</span>
                        </a>
                    </li>
        ...
        <div class="product-info">
            ...
            <h3 class="title18 text-upprcase product-title dosis-font font-bold">
                <a href="#" class="black" title="MÈO TRI CỤP">MÈO TRI CỤP</a>
            </h3>
            <div class="product-price simple">
...
<div class="block-element product-item-1 product-grid-view default js-content-wrap">
    <div class="products row list-product-wrap js-content-main">
        <div class="list-col-item list-4-item post-86466">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal5')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i> 
                            <span>Xem nhanh</span>
                        </a>
                    </li>
        ...
        <div class="product-info">
            ...
            <h3 class="title18 text-upprcase product-title dosis-font font-bold">
                <a href="#" class="black" title="PHỐC SỐC">PHỐC SỐC</a>
            </h3>
            <div class="product-price simple">
        ...
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal6')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
...
<div class="list-col-item list-4-item">
    <div class="item-product item-product-grid">
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal7')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
        ...
        <div class="product-info">
            ...
            <h3 class="title18 text-upprcase product-title dosis-font font-bold">
                <a href="#" class="black" title="MÈO CHÂN NGẮN">MÈO CHÂN NGẮN</a>
            </h3>
            <div class="product-price simple">
        ...
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal8')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
                ...
                <div class="product-thumb">
                    ...
                    <div class="product-extra-link text-center product" style="z-index:1">
                        <ul class="list-product-extra-link list-inline-block">
                            ...
                            <li>
                                <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal9')">
                                    <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                                    <span>Xem nhanh</span>
                                </a>
                            </li>
        ...
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal10')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
...
<div class="list-col-item list-4-item">
    <div class="item-product item-product-grid">
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal11')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
        ...
        <div class="modal" id="productModal11"> 
                    <div class="modal-content">  
                        <span class="close" onclick="closeModal('productModal11')">&times;</span>        
                            <h2>Chi tiết sản phẩm</h2>
                            <div class="produt-details">
                                <p><strong>Tên sản phẩm:</trong> </p>
                                <p><strong>Giá:</trong> <p>
...
<div class="list-col-item list-4-item">
    <div class="item-product item-product-grid">
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal12')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
        ...
        <div class="modal" id="productModal12"> 
                    <div class="modal-content">  
                        <span class="close" onclick="closeModal('productModal12')">&times;</span>        
                            <h2>Chi tiết sản phẩm</h2>
                            <div class="produt-details">
                                <p><strong>Tên sản phẩm:</trong> </p>
                                <p><strong>Giá:</trong> <p>
...
<div class="list-col-item list-4-item">
    <div class="item-product item-product-grid">
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal13')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
        ...
        <div class="modal" id="productModal13"> 
                    <div class="modal-content">  
                        <span class="close" onclick="closeModal('productModal13')">&times;</span>        
                            <h2>Chi tiết sản phẩm</h2>
                            <div class="produt-details">
                                <p><strong>Tên sản phẩm:</trong> </p>
                                <p><strong>Giá:</trong> <p>
...
<div class="list-col-item list-4-item">
    <div class="item-product item-product-grid">
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal14')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
        ...
        <div class="modal" id="productModal14"> 
                    <div class="modal-content">  
                        <span class="close" onclick="closeModal('productModal14')">&times;</span>        
                            <h2>Chi tiết sản phẩm</h2>
                            <div class="produt-details">
                                <p><strong>Tên sản phẩm:</trong> </p>
                                <p><strong>Giá:</trong> <p>
        ...
        <div class="product-info">
            ...
            <h3 class="title18 text-upprcase product-title dosis-font font-bold">
                <a href="#" class="black" title="GOLDEN CÁI">GOLDEN CÁI</a>
            </h3>
            <div class="product-price simple">
                <span class="woocommerce-Price-amount amount">1.000.000
                    <span class="product-Price-currencySymbol">&#x20AB;</span>
...
<div class="list-col-item list-4-item">
    <div class="item-product item-product-grid">
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal15')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
        ...
        <div class="modal" id="productModal15"> 
                    <div class="modal-content">  
                        <span class="close" onclick="closeModal('productModal15')">&times;</span>        
                            <h2>Chi tiết sản phẩm</h2>
                            <div class="produt-details">
                                <p><strong>Tên sản phẩm:</trong> </p>
                                <p><strong>Giá:</trong> <p>
...
<div class="list-col-item list-4-item">
    <div class="item-product item-product-grid">
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal16')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
        ...
        <div class="modal" id="productModal16"> 
                    <div class="modal-content">  
                        <span class="close" onclick="closeModal('productModal16')">&times;</span>        
                            <h2>Chi tiết sản phẩm</h2>
                            <div class="produt-details">
                                <p><strong>Tên sản phẩm:</trong> </p>
                                <p><strong>Giá:</trong> <p>
...
<div class="list-col-item list-4-item">
    <div class="item-product item-product-grid">
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal17')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
            ...
            <div class="modal" id="productModal17"> 
                <div class="modal-content">  
                    <span class="close" onclick="closeModal('productModal17')">&times;</span>        
                    <h2>Chi tiết sản phẩm</h2>
                    <div class="produt-details">
                        <p><strong>Tên sản phẩm:</trong> </p>
                        <p><strong>Giá:</trong> <p>
        ...
        <div class="product-info">
            ...
            <div class="product-price simple">
                <span class="woocommerce-Price-amount amount">4.000.000
                    <span class="product-Price-currencySymbol">&#x20AB;</span>
                </span>
            </div>
            <ul class="wrap-rating list-inline-block">
...
<div class="list-col-item list-4-item">
    <div class="item-product item-product-grid">
        <div class="product-thumb">
            <a href="#" class="product-thumb-link zoom-thumb">
                <img src="./assets/Image/img19.jpg" width="270" height="270" class="attachment-270*270 size-270*270 wp-post-image" alt="" srcset="
                ./assets/Image/img19.jpg 270w,  
                ./assets/Image/img19.jpg 150w, 
                ./assets/Image/img19.jpg 300w, 
                ./assets/Image/img19.jpg 266w, 
                ./assets/Image/img19.jpg 90w, 
                ./assets/Image/img19.jpg 70w, 
                ./assets/Image/img19.jpg 50w" 
                sizes="(max-width: 270px) 100vw, 270px">
            </a>
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal18')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
            ...
            <div class="modal" id="productModal18"> 
                <div class="modal-content">  
                    <span class="close" onclick="closeModal('productModal18')">&times;</span>        
                    <h2>Chi tiết sản phẩm</h2>
                    <div class="produt-details">
                        <p><strong>Tên sản phẩm:</trong> </p>
                        <p><strong>Giá:</trong> <p>
        ...
        <div class="product-info">
            <span class="title12 text-upprcase color font-bold">ID:SP00015</span>
            <h3 class="title18 text-upprcase product-title dosis-font font-bold">
                <a href="#" class="black" title="GOLDEN CÁI">MÈO XÁM ĐỰC</a>
            </h3>
            <div class="product-price simple">
        ...
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal19')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
            ...
            <div class="modal" id="productModal19"> 
                <div class="modal-content">  
                    <span class="close" onclick="closeModal('productModal19')">&times;</span>        
                    <h2>Chi tiết sản phẩm</h2>
                    <div class="produt-details">
                        <p><strong>Tên sản phẩm:</trong> </p>
                        <p><strong>Giá:</trong> <p>
        ...
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal20')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
            ...
            <div class="modal" id="productModal20"> 
                <div class="modal-content">  
                    <span class="close" onclick="closeModal('productModal20')">&times;</span>        
                    <h2>Chi tiết sản phẩm</h2>
                    <div class="produt-details">
                        <p><strong>Tên sản phẩm:</trong> </p>
                        <p><strong>Giá:</trong> <p>
        ...
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal21')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
            ...
            <div class="modal" id="productModal21"> 
                <div class="modal-content">  
                    <span class="close" onclick="closeModal('productModal21')">&times;</span>        
                    <h2>Chi tiết sản phẩm</h2>
                    <div class="produt-details">
                        <p><strong>Tên sản phẩm:</trong> </p>
                        <p><strong>Giá:</trong> <p>
        ...
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal22')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
            ...
            <div class="modal" id="productModal22"> 
                <div class="modal-content">  
                    <span class="close" onclick="closeModal('productModal22')">&times;</span>        
                    <h2>Chi tiết sản phẩm</h2>
                    <div class="produt-details">
                        <p><strong>Tên sản phẩm:</trong> </p>
                        <p><strong>Giá:</trong> <p>
        ...
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal23')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
            ...
            <div class="modal" id="productModal23"> 
                <div class="modal-content">  
                    <span class="close" onclick="closeModal('productModal23')">&times;</span>        
                    <h2>Chi tiết sản phẩm</h2>
                    <div class="produt-details">
                        <p><strong>Tên sản phẩm:</trong> </p>
                        <p><strong>Giá:</trong> <p>
        ...
        <div class="product-thumb">
            ...
            <div class="product-extra-link text-center product" style="z-index:1">
                <ul class="list-product-extra-link list-inline-block">
                    ...
                    <li>
                        <a title="Xem nhanh" data-product-id="86466" hrel="#" class="product-quick-view quickview-link" onclick="openModal(event, 'productModal24')">
                            <i class="fa-light fa-magnifying-glass" style="position: relative; top: -7px; left: -7px; font-size: 1.2rem;"></i>
                            <span>Xem nhanh</span>
                        </a>
                    </li>
            ...
            <div class="modal" id="productModal24"> 
                <div class="modal-content">  
                    <span class="close" onclick="closeModal('productModal24')">&times;</span>        
                    <h2>Chi tiết sản phẩm</h2>
                    <div class="produt-details">
                        <p><strong>Tên sản phẩm:</trong> </p>
                        <p><strong>Giá:</trong> <p>
